...
for observation $i = i, \dots, n_j$ in group $j = 1, \dots, a$. We also have
that:
...
where $\tau^{-1}$ is the residual precision. In this setting, $M_{k}$ will
...
tree k in terminal node 1. Now, let 
...
which is used yo get the marginal distribution of a new tree. The new
